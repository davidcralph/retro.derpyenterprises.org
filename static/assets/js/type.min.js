...
this.el.innerHTML='<span class="wrap"><span style="color: transparent;">.</span>'+this.txt+'</span>';var that=this;var delta=95-Math.random()*45;if(this.isDeleting){delta/=2}
...
var current=0,slides=document.getElementsByClassName("background");setInterval(function(){for(var i=0;i<slides.length;i++){slides[i].style.opacity=0}
current=(current!=slides.length-1)?current+1:0},10000)}